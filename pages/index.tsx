...
const Home: NextPage = () => {
  ...
  const [gradelevel, setGradelevel] = useState<GradelevelType>("Vrtec");
  ...
  const prompt = `Please create ${lessonPlanType === "Detailed Lesson Plan" ? "a complete and " : ""
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault();
    generateTopic().catch(async (error) => {
      // Handle errors here
      console.error(error);
      ...
      setGeneratedTopics(translatedText as any);
